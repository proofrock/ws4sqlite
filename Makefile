...
zbuild:
	make build
	cd bin; 7zr a -mx9 -t7z ws4sqlite-v0.12.4-`uname -s|tr '[:upper:]' '[:lower:]'`-`uname -m`.7z ws4sqlite
...
docker-publish:
	...
	sudo docker push germanorizzo/ws4sqlite:v0.12.4-amd64
	sudo docker push germanorizzo/ws4sqlite:v0.12.4-arm
	sudo docker push germanorizzo/ws4sqlite:v0.12.4-arm64
	sudo docker manifest create -a germanorizzo/ws4sqlite:v0.12.4 germanorizzo/ws4sqlite:v0.12.4-amd64 germanorizzo/ws4sqlite:v0.12.4-arm germanorizzo/ws4sqlite:v0.12.4-arm64
	sudo docker manifest push germanorizzo/ws4sqlite:v0.12.4
	sudo docker manifest rm germanorizzo/ws4sqlite:latest
	sudo docker manifest create germanorizzo/ws4sqlite:latest germanorizzo/ws4sqlite:v0.12.4-amd64 germanorizzo/ws4sqlite:v0.12.4-arm germanorizzo/ws4sqlite:v0.12.4-arm64
