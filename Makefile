...
zbuild-all:
	...
	cd src; 7zr a -mx9 -t7z ../bin/ws4sqlite-v0.11.3-linux-amd64.7z ws4sqlite
	rm src/ws4sqlite
	cd src; CGO_ENABLED=0 GOOS=linux GOARCH=arm go build -a -tags netgo,osusergo -ldflags '-w -extldflags "-static"'
	cd src; 7zr a -mx9 -t7z ../bin/ws4sqlite-v0.11.3-linux-arm.7z ws4sqlite
	rm src/ws4sqlite
	cd src; CGO_ENABLED=0 GOOS=linux GOARCH=arm64 go build -a -tags netgo,osusergo -ldflags '-w -extldflags "-static"'
	cd src; 7zr a -mx9 -t7z ../bin/ws4sqlite-v0.11.3-linux-arm64.7z ws4sqlite
	rm src/ws4sqlite
	cd src; CGO_ENABLED=0 GOOS=linux GOARCH=riscv64 go build -a -tags netgo,osusergo -ldflags '-w -extldflags "-static"'
	cd src; 7zr a -mx9 -t7z ../bin/ws4sqlite-v0.11.3-linux-riscv64.7z ws4sqlite
	rm src/ws4sqlite
	cd src; CGO_ENABLED=0 GOOS=darwin GOARCH=amd64 go build
	cd src; 7zr a -mx9 -t7z ../bin/ws4sqlite-v0.11.3-darwin-amd64.7z ws4sqlite
	rm src/ws4sqlite
	cd src; CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build
	cd src; 7zr a -mx9 -t7z ../bin/ws4sqlite-v0.11.3-darwin-arm64.7z ws4sqlite
	rm src/ws4sqlite
	cd src; CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build
	cd src; 7zr a -mx9 -t7z ../bin/ws4sqlite-v0.11.3-win-amd64.7z ws4sqlite.exe
	rm src/ws4sqlite.exe
	cd src; CGO_ENABLED=0 GOOS=windows GOARCH=arm64 go build
	cd src; 7zr a -mx9 -t7z ../bin/ws4sqlite-v0.11.3-win-arm64.7z ws4sqlite.exe
	rm src/ws4sqlite.exe
	cd src; CGO_ENABLED=0 GOOS=freebsd GOARCH=amd64 go build
	cd src; 7zr a -mx9 -t7z ../bin/ws4sqlite-v0.11.3-freebsd-amd64.7z ws4sqlite
	rm src/ws4sqlite
