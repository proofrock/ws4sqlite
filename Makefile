...
zbuild:
	make build
	cd bin; 7zr a -mx9 -t7z ws4sqlite-v0.12.2-`uname -s|tr '[:upper:]' '[:lower:]'`-`uname -m`.7z ws4sqlite
...
docker-publish:
	...
	sudo docker buildx build --no-cache -t germanorizzo/ws4sqlite:v0.12.2-amd64 .
	sudo docker buildx build --no-cache --platform linux/arm/v7 -t germanorizzo/ws4sqlite:v0.12.2-arm .
	sudo docker buildx build --no-cache --platform linux/arm64/v8 -t germanorizzo/ws4sqlite:v0.12.2-arm64 .
	sudo docker push germanorizzo/ws4sqlite:v0.12.2-amd64
	sudo docker push germanorizzo/ws4sqlite:v0.12.2-arm
	sudo docker push germanorizzo/ws4sqlite:v0.12.2-arm64
	sudo docker manifest create -a germanorizzo/ws4sqlite:v0.12.2 germanorizzo/ws4sqlite:v0.12.2-amd64 germanorizzo/ws4sqlite:v0.12.2-arm germanorizzo/ws4sqlite:v0.12.2-arm64
	sudo docker manifest push germanorizzo/ws4sqlite:v0.12.2
	sudo docker manifest rm germanorizzo/ws4sqlite:latest
	sudo docker manifest create germanorizzo/ws4sqlite:latest germanorizzo/ws4sqlite:v0.12.2-amd64 germanorizzo/ws4sqlite:v0.12.2-arm germanorizzo/ws4sqlite:v0.12.2-arm64
